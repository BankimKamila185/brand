    ...
    select: {
      ...
      product: {
        select: {
          ...
          variants: {
            where: { isActive: true },
            select: { id: true, title: true, price: true, comparePrice: true, option1: true },
            orderBy: { position: 'asc' }, take: 5,
          },
          images: { select: { src: true, altText: true }, take: 2, orderBy: { position: 'asc' } },
        },
      },
    },
