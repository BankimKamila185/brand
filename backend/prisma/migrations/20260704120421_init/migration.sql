...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_UPDATE', 'PROMO', 'SYSTEM', 'REVIEW_APPROVED');
...
CREATE TABLE "products" (
    ...
    "handle" TEXT NOT NULL,
    "description" TEXT,
    "vendor" TEXT NOT NULL DEFAULT 'Tevar',
...
-- CreateIndex
CREATE INDEX "collections_handle_idx" ON "collections"("handle");
