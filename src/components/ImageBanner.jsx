      ...
      <div className="relative w-full overflow-hidden rounded-lg group aspect-[21/9] max-md:aspect-[4/3] bg-neutral-900 shadow-md">
        <Link href={link} className="block w-full h-full relative">
          ...
          <div className="absolute bottom-8 left-8 md:bottom-16 md:left-16 max-w-xl text-white z-10 space-y-3 md:space-y-4">
            <span className="text-[10px] md:text-xs uppercase tracking-widest text-neutral-300 font-semibold block">
              New Season
            </span>
            <h2 className="text-2xl md:text-5xl font-bold tracking-tight text-white leading-tight">
              {title}
            </h2>
            <p className="text-xs md:text-lg text-neutral-200 font-light max-w-md">
              {subtitle}
            </p>
            <div className="pt-2">
