        ...
        <div className="hoo-footer-grid">
          ...
          <div className="hoo-footer-col">
            ...
            <div className="hoo-socials">
              ...
              {/* Twitter/X */}
              <a href="https://x.com/theoutliersstudio" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="X (Twitter)" title="Follow us on X">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@theoutliersstudio" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="YouTube" title="Subscribe on YouTube">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
