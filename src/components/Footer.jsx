  ...
  return (
    <>
      ...
      <footer className="hoo-footer">
        ...
        {/* Brand logo — centered and linked */}
        <div className="hoo-footer-wordmark-strip">
          <Link href="/" aria-label="The Outliers Studio Home" className="inline-block transition-opacity hover:opacity-100">
        ...
        <div className="hoo-footer-grid">
          ...
          <div className="hoo-footer-col">
            ...
            <div className="hoo-contact-row">
              <a href="tel:+917304406772" className="hoo-contact-item" title="Call customer support">
              ...
              <a href="mailto:support@theoutliersstudio.com" className="hoo-contact-item" title="Email customer support">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="hoo-socials">
              {/* Instagram */}
              <a href="https://instagram.com/theoutliersstudio" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="Instagram" title="Follow us on Instagram">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/917304406772?text=Hi%20The%20Outliers%20Studio%2C%20I%20have%20an%20inquiry." target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="WhatsApp" title="Chat on WhatsApp">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61593738772874" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="Facebook" title="Follow us on Facebook">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              {/* Twitter/X */}
              <a href="https://x.com/Outliers_Studio" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="X (Twitter)" title="Follow us on X">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/channel/UC23eIT-fay1tUn8V77CFYuA" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="YouTube" title="Subscribe on YouTube">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="hoo-footer-col">
            ...
            <ul className="hoo-nav-links">
              ...
              <li><Link href="/policies/faq">FAQ &amp; Help Center</Link></li>
              ...
              <li><Link href="/policies/about">About Outliers</Link></li>
            </ul>
          </div>
          ...
          <div className="hoo-footer-col">
            ...
            {subscribed ? (
              <div className="hoo-subscribed-msg">
                ...
                You&apos;re in — welcome to the Outliers Club!
              </div>
            ) : (
