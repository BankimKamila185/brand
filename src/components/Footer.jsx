        ...
        <div className="hoo-footer-grid">
          ...
          <div className="hoo-footer-col">
            ...
            <div className="hoo-contact-row">
              <a href="tel:+919900975154" className="hoo-contact-item">
            ...
            <div className="hoo-socials">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/919900975154" target="_blank" rel="noopener noreferrer" className="hoo-social-btn" aria-label="WhatsApp">
