          ...
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <p className="footer-text" style={{ marginTop: "20px" }}>
                <a href="tel:+919900975154" className="footer-link-underline">
                  +919900975154
                </a>
              </p>
              <p className="footer-text">
                <a
                  href="mailto:support@___HOUSEOFOUTLIERS_DOM___"
                  className="footer-link-underline"
                >
                  support@___HOUSEOFOUTLIERS_DOM___
                </a>
              </p>
            ...
            <div className="footer-col">
              ...
              <ul className="footer-links">
                <li>
                  <Link href="/policies/refund-policy">Return / Exchange</Link>
                </li>
                <li>
            ...
            <div className="footer-col">
              ...
              <ul className="footer-links">
                <li>
                  <Link href="/collections/cargo-trousers-for-men">
                ...
                <li>
                  <Link href="/collections/co-ord-sets">Co-ord Set</Link>
                </li>
              </ul>
            </div>
