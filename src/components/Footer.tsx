      ...
      <footer className="site-footer">
        <div className="footer-container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <p className="footer-text">
                <a href="mailto:support@theoutliersstudio.com" className="footer-link-underline">support@theoutliersstudio.com</a>
              </p>
            ...
            <div className="footer-col newsletter-col">
              <h3 className="newsletter-heading">Join The Outliers Studio</h3>
        ...
        <div className="footer-bottom">
          <div className="footer-container bottom-flex">
            <p>©2025 The Outliers Studio Private Limited</p>
