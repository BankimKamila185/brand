...
export function Overview() {
  ...
  useEffect(() => {
    Promise.all([adminApi.orders.list(), adminApi.products.list()])
      .then(([orderResult, productResult]) => { setOrders(orderResult.data || []); setProducts(productResult.data || []); })
  ...
  const stats = [
    { label: "Orders in", value: orders.length, note: "Live order feed", icon: ReceiptText, accent: "coral" },
