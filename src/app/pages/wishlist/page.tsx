    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <div className="collection-hero">
          ...
          <p className="collection-hero-count">{wishlistProducts.length} Saved Items</p>
        </div>
        ...
        <div className="container-fluid py-12">
          ...
          {wishlistProducts.length === 0 ? (
            <div className="text-center py-24">
              ...
              <p className="text-gray-500 mb-8">Save your favourite items while you browse our collections.</p>
              <Link href="/collections/all" className="bg-black text-white px-10 py-4 inline-block font-bold uppercase tracking-widest text-sm rounded">
                Start Shopping
              </Link>
            </div>
          ) : (
            <>
              ...
              <div className="text-center mt-8">
                <button
                  ...
                  onClick={() => wishlistProducts.forEach((p) => addToCart(p, p.options[0]?.values[0] || 'M'))}
                >
                  Add All to Cart
                </button>
              </div>
