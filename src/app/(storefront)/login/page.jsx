...
function LoginForm() {
  ...
  const { login, register, forgotPassword, isAuthenticated, loginWithGoogle, loginWithApple } = useAuth();
    ...
    <div className="tevar-login-container relative overflow-x-hidden">
      ...
      <div className="tevar-login-right">
        ...
        <div className="flex-1 flex flex-col justify-center gap-6 my-auto">
            ...
            {activeTab === 'register' ? (
              ...
              >
                ...
                <div className="flex items-center justify-between px-1 text-xs select-none">
                  ...
                  <button 
                    type="button"
                    onClick={() => { setActiveTab('forgot'); setError(''); setSuccess(''); setForgotEmail(loginEmail); }} 
          ...
          {/* Social Sign up separators (show only on login or register) */}
          {activeTab !== 'forgot' && (
