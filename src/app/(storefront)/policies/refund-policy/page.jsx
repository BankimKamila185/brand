        ...
        <div className="container-fluid py-16 max-w-3xl mx-auto">
          ...
          <div className="policy-content">
            ...
            <p>
              ...
              respond within 24 hours with return instructions.
            </p>
            ...
            <p>
              ...
              once your refund is issued.
            </p>

            <h2>Exchanges</h2>
            <p>
              We offer free exchanges for size or colour differences, subject to
              availability. Please email us to arrange an exchange.
            </p>

            <h2>Damaged or Wrong Items</h2>
            <p>
              If you received a damaged, defective, or incorrect item, please
              contact us immediately at{" "}
              <a href="mailto:hello@___HOUSEOFOUTLIERS_DOM___">
                hello@___HOUSEOFOUTLIERS_DOM___
              </a>{" "}
              with photos. We will arrange a replacement or full refund at no
              extra cost.
            </p>
          </div>
        </div>
