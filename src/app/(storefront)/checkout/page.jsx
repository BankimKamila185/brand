    ...
    <CheckoutFrame>
      <main className="checkout-v3-main flex-1">
        <div className="checkout-v3-shell mx-auto max-w-[1240px] px-4 md:px-6">
          ...
          className="col-span-full flex items-center justify-center gap-2 bg-white border border-neutral-200 hover:border-neutral-800 hover:bg-neutral-100 px-4 py-3 text-xs font-bold uppercase tracking-widest text-neutral-800 transition-all duration-200 rounded-lg"
          disabled={locating}
        >
