                                      ...
                                      return sizesToDisplay.map((sz) => {
                                        ...
                                        return (
                                          <button
                                            ...
                                            onClick={async (e) => {
                                              e.stopPropagation();
                                              const nextId = await updateItemSize(item.variantId, sz, item.product);
                                              if (nextId) setEditingSizeVariantId(nextId);
                                            }}
                              ...
                              >
                                <div>
                                  <div className="flex items-center gap-1.5">
                                    <span className="font-extrabold uppercase tracking-wide text-[11px] bg-white px-2 py-0.5 rounded border border-neutral-200">
                                      {c.code}
                                    </span>
